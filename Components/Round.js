...
import round6 from '../assets/ArrowLC.png'
import round7 from '../assets/Arrowrc.png'
    ...
    <div className='round'>
      <div className="round-container">
        <div className="round1">
          <img className='iimgg' src={round6} alt="round6" />
            <div className="r1">
            ...
            <img className='iimgg1' src={round7} alt="round7" />
        </div>
